...
// internal/config, internal/toolchain (for toolchain.Status only),
// internal/provider/treesitter/lang (the pinned grammar registry compiled into
// this binary, which is the subject of the bundled-grammar check and therefore
// cannot arrive through a fake), and the standard library. It must NOT import internal/app, internal/cli or
